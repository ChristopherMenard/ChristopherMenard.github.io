const translations = 
{
  ...
  en: {
        ...
        discount_desc2: "I developed two weapons: a melee weapon used to steal items from other customers, and a potato launcher that slows down enemies from a distance. The weapon system uses object pooling to optimize performance, and includes upgrades that enhance attack speed, projectile range, and projectile velocity, as well as full collision handling and enemy behavior reactions.",
        ...
        ethereal_info5: "Tools : Unreal Engine 4 | Perforce | Handsoft | Notion",
        ethereal_info6: "Steam Page",
